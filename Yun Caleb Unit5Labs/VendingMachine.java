                            ...
                            implements ActionListener
{
  ...
  public VendingMachine(String brand, int price)
  {
    ...
    deposit25c = new JButton(" 25 ");
    deposit25c.addActionListener(this);
    deposit10c = new JButton(" 10 ");
    deposit10c.addActionListener(this);
    deposit5c = new JButton("  5 ");
    ...
    else if (b == go)
    {
      ...
      if (trayFull)          // Successful sale
      {
          ...
          if (change>0) 
            ...
            "            " + brandName, JOptionPane.PLAIN_MESSAGE);
          else
            JOptionPane.showMessageDialog(null,
            "Enjoy your " + brandName + "\n",
            "            " + brandName, JOptionPane.PLAIN_MESSAGE);
      ...
      {
          JOptionPane.showMessageDialog(null,
          "Deposit of " + change + "c not enough for purchase.",
